...
import {
  getNewGroup,
  getNewRule,
} from "../components/rules/ruleBuilder/actions";
...
const parseRedirectRules = (modheaderProfile: ModheaderProfile): Rule[] | null=> {
...
const parseCookieHeaders = (modheaderProfile: ModheaderProfile): Rule |  null => {
