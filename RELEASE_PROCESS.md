...
4. Select release type:
   ...
   - **`patch`** - bug fixes (0.0.11 → 0.0.12)
   - **`minor`** - new features (0.0.11 → 0.1.0)
   - **`major`** - breaking changes (0.0.11 → 1.0.0)
5. Click **"Run workflow"** button
6. Wait ~1 minute for PR to be created

**Result:** A PR will be created with title like `[Release] v0.0.12`
...
- Verify on **[npm](https://www.npmjs.com/package/@requestly/alternative-importers)**
...
|----------|--------------|---------|
| Bug fixes only | `patch` | 0.0.11 → 0.0.12 |
| New features (backward compatible) | `minor` | 0.0.11 → 0.1.0 |
| Breaking changes | `major` | 0.0.11 → 1.0.0 |
...
git add .
git commit -m "feat: add new importer feature"
...
# - ✅ Publishes @requestly/alternative-importers@0.1.0 to npm

# 6. Verify the release
# Check npm: https://www.npmjs.com/package/@requestly/alternative-importers
# Check GitHub: https://github.com/requestly/alternative-importers/releases
